...
def RestartButton():
    pygame.draw.line(Screen, BLACK, [1300,100], [1300,150], 2)
    pygame.draw.line(Screen, BLACK, [1350,100], [1350,150], 2)
    pygame.draw.line(Screen, BLACK, [1300,100], [1350,100], 2)
    pygame.draw.line(Screen, BLACK, [1300,150], [1350,150], 2)
    font = pygame.font.SysFont(None, 21)
    text = font.render("Restart", True, RED)
    Screen.blit(text, (1300, 160))
...
while True:
    for new_event in pygame.event.get():
        ...
        if new_event.type == pygame.MOUSEBUTTONUP:
            ...
            button_set = [[1300,100],[1300,125],[1300,150],[1325,100],[1325,125],[1325,150],[1350,100],[1350,125],[1350,150]]
            ...
            if intersection_position in empty_intersection:
                if n%2 == 1:
                    ...
                    if black_1 == True:
                        ...
                        reminder = font.render("GAME OVER!", True, BLACK)
